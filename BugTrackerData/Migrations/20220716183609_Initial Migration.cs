        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CommentMessage = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    CommentAuthorId = table.Column<long>(type: "bigint", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrgranizationId = table.Column<long>(type: "bigint", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TeamMembers_Organization_OrgranizationId",
                        column: x => x.OrgranizationId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Tickets_TeamMembers_AuthorId",
                        column: x => x.AuthorId,
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Tickets_TicketsStatuses_StatusId",
                        column: x => x.StatusId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TeamMembers_OrgranizationId",
                table: "TeamMembers",
                column: "OrgranizationId");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Comments_TeamMembers_CommentAuthorId",
                table: "Comments",
                column: "CommentAuthorId",
                principalTable: "TeamMembers",
                principalColumn: "Id",
